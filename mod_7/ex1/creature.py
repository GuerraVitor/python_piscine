...
class Bloomelle(Creature, HealCapability):
    ...
    def heal(self, target: str | None = None) -> str:
        if target is None:
            return "Bloomelle heals itself and allies for a large amount"
        return f"Bloomelle heals {target} and allies for a large amount"
...
class Morphagon(Creature, TransformCapability):
    ...
    def attack(self) -> str:
        if self.is_transformed:
            return "Morphagon performs a devastating strike!"
