...
def main():
    ...
    only_capitalized = [name for name in all_players if name[0] >= 'A' and name[0] <= 'Z']
    ...
    high_scores ={name: score_dict[name] for name in score_dict if score_dict[name] > average_score}
